...
- [x] make sure creep hull is used to stay on creep
- [x] make creep hull update eager (check townhall tags)
...
- avoid getting farmed at creep edge
- destroy destructables on our creep when we have time