...
class ZergRushBot(iBot):

    def __init__(self):
        super(ZergRushBot, self).__init__()
    ...
    async def on_step(self, iteration):
        ...
        if self.supply_left < 2 and self.already_pending(UnitTypeId.OVERLORD) < 1 and self.structures(UnitTypeId.SPAWNINGPOOL).exists:
